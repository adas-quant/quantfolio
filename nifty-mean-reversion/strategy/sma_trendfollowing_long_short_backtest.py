...
plt.plot(df.index, strategy_curve, label='SMA Trend Following')
plt.plot(df.index, buyhold, label='Buy & Hold')
plt.title('SMA Trend Following vs Buy & Hold')
plt.xlabel('Date')
plt.ylabel('Cumulative Returns')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('../plots/sma_trendfollowing_vs_buyhold.png')
plt.show()
...
trade_log_df.to_csv(os.path.join(result_dir, 'sma_trendfollowing_trades.csv'), index=False)
print("\nTrade log saved to results/sma_trendfollowing_trades.csv")
